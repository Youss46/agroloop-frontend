...
const team = [
  {
    ...
    description: "Responsable de la stratégie d'entreprise et du développement des partenariats. Il pilote la vision business d'AgroLoopCI et ouvre les portes aux acteurs clés de l'agro-industrie en Côte d'Ivoire.",
    bg: "bg-primary/10",
    color: "text-primary",
  },
  {
  ...
  },
  {
    ...
    description: "Architecte de la plateforme AgroLoopCI, il conçoit et développe l'ensemble des fonctionnalités techniques — de la marketplace à la carte géolocalisée — pour offrir une expérience fluide aux producteurs et transformateurs.",
    bg: "bg-blue-100",
    color: "text-blue-700",
  },
];
